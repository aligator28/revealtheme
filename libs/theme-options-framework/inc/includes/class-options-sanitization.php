...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'revealpresentation' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'revealpresentation' ),
		'repeat-y'  => __( 'Repeat Vertically', 'revealpresentation' ),
		'repeat'    => __( 'Repeat All', 'revealpresentation' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'revealpresentation' ),
		'top center'    => __( 'Top Center', 'revealpresentation' ),
		'top right'     => __( 'Top Right', 'revealpresentation' ),
		'center left'   => __( 'Middle Left', 'revealpresentation' ),
		'center center' => __( 'Middle Center', 'revealpresentation' ),
		'center right'  => __( 'Middle Right', 'revealpresentation' ),
		'bottom left'   => __( 'Bottom Left', 'revealpresentation' ),
		'bottom center' => __( 'Bottom Center', 'revealpresentation' ),
		'bottom right'  => __( 'Bottom Right', 'revealpresentation')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'revealpresentation' ),
		'fixed'  => __( 'Fixed in Place', 'revealpresentation')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'revealpresentation' ),
		'italic'      => __( 'Italic', 'revealpresentation' ),
		'bold'        => __( 'Bold', 'revealpresentation' ),
		'bold italic' => __( 'Bold Italic', 'revealpresentation' )
		);
