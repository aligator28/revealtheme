...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="background-image: url('<?php if ( '' !== get_the_post_thumbnail() && ! is_single() ) : the_post_thumbnail_url( 'large' ); else: echo get_template_directory_uri().'/images/bg_trans.pn'; endif; ?>')">
	<?php
