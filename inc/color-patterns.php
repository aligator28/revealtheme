 ...
 */
function reveal_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'reveal_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.reveal-front-page) .entry-title,
...
.colors-custom .reveal-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.reveal-front-page .panel-content .recent-posts article,
...
.colors-custom.reveal-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'reveal_custom_colors_css', $css, $hue, $saturation );
}
