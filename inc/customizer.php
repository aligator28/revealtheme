...
function twentyseventeen_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'colorscheme', array(
		'type'    => 'radio',
		'label'    => __( 'Color Scheme', 'revealpresentation' ),
		'choices'  => array(
			'light'  => __( 'Light', 'revealpresentation' ),
			'dark'   => __( 'Dark', 'revealpresentation' ),
			'custom' => __( 'Custom', 'revealpresentation' ),
		),
		'section'  => 'colors',
		'priority' => 5,
	) );
	...
	$wp_customize->add_section( 'theme_options', array(
		'title'    => __( 'Theme Options', 'revealpresentation' ),
	...
	$wp_customize->add_control( 'page_layout', array(
		'label'       => __( 'Page Layout', 'revealpresentation' ),
		'section'     => 'theme_options',
		'type'        => 'radio',
		'description' => __( 'When the two column layout is assigned, the page title is in one column and content is in the other.', 'revealpresentation' ),
		'choices'     => array(
			'one-column' => __( 'One Column', 'revealpresentation' ),
			'two-column' => __( 'Two Column', 'revealpresentation' ),
		),
	...
	for ( $i = 1; $i < ( 1 + $num_sections ); $i++ ) {
		...
		$wp_customize->add_control( 'panel_' . $i, array(
			...
			'label'          => sprintf( __( 'Front Page Section %d Content', 'revealpresentation' ), $i ),
			'description'    => ( 1 !== $i ? '' : __( 'Select pages to feature in each area from the dropdowns. Add an image to a section by setting a featured image in the page editor. Empty sections will not be displayed.', 'revealpresentation' ) ),
			'section'        => 'theme_options',
			'type'           => 'dropdown-pages',
			'allow_addition' => true,
