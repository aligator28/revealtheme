...
echo sprintf( __( "Hi there. Your order on %s has been refunded. Your order details are shown below for your reference:", 'revealpresentation' ), get_option( 'blogname' ) ) . "\n\n";
